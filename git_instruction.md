...
По умолчаниб имя основной ветки в Git-master
```
...
Для слияние веток используется команда `git merge название ветки` слияние ветки будет в той на которой находимся. 
## 3. Удаление веток
